...
### Big5 성격 검사
  ...
  - 테스트 페이지
    ...
    - 총 30개의 질문으로 이루어져 있습니다. 
    - 질문은 총 5개의 성향으로 이루어져 있으며 각 성향마다 3가지 유형으로 나누었습니다. 
      - (5가지 성향: 개방성, 성실성, 외향성, 친화성, 감정민감성)
    - 한 성향 당 6문제로 이루어져 있습니다. 
    - 30개의 질문에 대답하면 결과 페이지가 나옵니다.
 
 - 결과 페이지
 
    - 성향과 유형별로 점수가 합산해서 나옵니다.
    - 그 중 가장 높은 성향은 상단에 알려줍니다.
